...
then
    ...
    mv -v packages/ticktick/x86.64/output/release/*.apk packages/latest/app/ticktick.x86.64.apk

    java -jar signer.jar --allowResign -a packages/ticktick/x86/output -o packages/ticktick/x86/output/release
    mv -v packages/ticktick/x86/output/release/*.apk packages/latest/app/ticktick.x86.apk

    java -jar signer.jar --allowResign -a packages/tiktok/output -o packages/tiktok/output/release
    mv -v packages/tiktok/output/release/*.apk packages/latest/app/tiktok.apk

    java -jar signer.jar --allowResign -a packages/twitch/output -o packages/twitch/output/release
    mv -v packages/twitch/output/release/*.apk packages/latest/app/twitch.apk
